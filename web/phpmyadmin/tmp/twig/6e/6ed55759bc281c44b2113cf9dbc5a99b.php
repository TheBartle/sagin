...
echo _gettext("(current)");
        ...
        // line 19
        echo "\t\t<li class=\"nav-item\">
            <a id=\"databasesagin\" class=\"nav-link text-nowrap\" href=\"url.php?url=https%3A%2F%2Fdatabases.sagin.pl%2Flogin\">
\t\t\t\tPanel baz
            </a>
\t\t\t<script>
\t\t\t
\t\t\t\tdocument.getElementById(\"databasesagin\").addEventListener('click', ()=> {
\t\t\t\twindow.location.replace(\"https://phpmyadmin.sagin.pl/url.php?url=https%3A%2F%2Fdatabases.sagin.pl%2Flogin\");
\t\t\t\t});
\t\t\t</script>
          </li>
      </ul>
