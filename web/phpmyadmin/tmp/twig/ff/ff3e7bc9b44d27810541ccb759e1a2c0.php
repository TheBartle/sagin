...
class __TwigTemplate_e98922cfb30509a910fb3c1803c2433e extends Template
{
    private $source;
    private $macros = [];
...
($context["servers"] ?? null), "select", [], "any", false, false, false, 35)]));
    ...
    {
        return new Source("", "server/select/index.twig", "/var/www/phpmyadmin/templates/server/select/index.twig");
    }
}
